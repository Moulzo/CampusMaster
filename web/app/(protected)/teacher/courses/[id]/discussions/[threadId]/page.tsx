...
export default function TeacherThreadMessagesPage() {
      ...
      <div className="p-6">
        <div className="bg-red-50 border border-red-200 rounded-lg p-4">
          ...
          <div className="mt-4">
            <button
              onClick={() =>
                router.push(`/teacher/courses/${courseId}?tab=discussions`)
              }
  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        <button
          onClick={() =>
            router.push(`${base}/courses/${courseId}?tab=discussions`)
          }
